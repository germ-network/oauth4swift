...
@Suite("Token revocation") struct RevocationTests {
	...
	static let accessToken = try! OAuth.AccessToken(value: "at-123", expiry: nil, fetchedOn: nil)
	static let refreshToken = try! OAuth.RefreshToken(value: "rt-456", expiry: nil, fetchedOn: nil)
